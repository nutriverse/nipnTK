# [`plot()`](https://rdrr.io/r/graphics/plot.default.html) helper functions for [`ageHeaping()`](https://nutriverse.io/nipnTK/dev/reference/ageHeaping.md) functions

[`plot()`](https://rdrr.io/r/graphics/plot.default.html) helper
functions for
[`ageHeaping()`](https://nutriverse.io/nipnTK/dev/reference/ageHeaping.md)
functions
