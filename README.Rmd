...
[![CRAN](https://img.shields.io/cran/v/nipnTK.svg)](https://cran.r-project.org/package=nipnTK){.pkgdown-release}
...
[![Codecov test coverage](https://codecov.io/gh/nutriverse/nipnTK/graph/badge.svg)](https://app.codecov.io/gh/nutriverse/nipnTK)
...
[![DOI](https://zenodo.org/badge/118171028.svg)](https://zenodo.org/badge/latestdoi/118171028){.pkgdown-release}
[![DOI](https://img.shields.io/badge/DOI-10.32614/CRAN.package.nipnTK-blue)](https://doi.org/10.32614/CRAN.package.nipnTK){.pkgdown-release}
<!-- badges: end -->
...
::: {.pkgdown-devel}
You can install the development version of `{nipnTK}` from [GitHub](https://github.com/nutriverse/nipnTK) using the `{pak}` package with:
...
You can also install `{nipnTK}` from the [nutriverse R Universe](https://nutriverse.r-universe.dev) with:
...
If you use the `{nipnTK}` package in your work, please cite using the suggested citation provided by a call to the `citation` function as follows:
