...
#' \item{\code{pct}}{Table of proportions (\code{\%}) of remainders (for \code{x \%\%} divisor)}
#' }
#' @examples
...
#' @return Printed output of the \code{ageHeaping()} function
#' @examples
...
#' @param ... Additional \code{plot()} graphical parameters
